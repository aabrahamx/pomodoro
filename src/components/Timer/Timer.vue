...
<template>
    ...
    <div id="timer-wrapper">
        <div>
            <div id="timer">
                <div>
                    <span id="session"></span>git add REAM
                    <span v-if="(timer.sessionRunning === 'work')">Work Session ⏰</span>
                    <span v-if="timer.sessionRunning === 'short'">Short Break 🧘🏽</span>
                    <span v-if="timer.sessionRunning === 'long'">Long Break 🏖</span>
                </div>
                <div id="time-holder">
